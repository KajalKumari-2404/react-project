// React Hook Challenge: Dynamic State Management and Document Title
// Update with useEffect

/*
Description: In this challenge, you'll create a React component that
dynamically manages state using useState and useEffect hooks. Your
